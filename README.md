# Enviral Design 3D Lab

This repository is a working lab fork/wrapper around TRELLIS.2 with local and
remote launchers for image-to-3D experiments, staged diagnostics, FaithC
experiments, and UltraShape refinement.

First-class setup path:
...
The original upstream TRELLIS.2 README follows.
